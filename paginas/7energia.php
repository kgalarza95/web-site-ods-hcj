          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-12 col-lg-6 mr-auto order-2 ml-5">
                <img src="../images/objetivos/7.jpg" alt="Image" class="img-fluid">
              </div>

              <div class="col-md-12 col-lg-5 mb-5 mb-lg-0 order-1">
                <h2 class="mb-3 text-uppercase">Objetivo 7
                  <strong class="letra-negra font-weight-bold">ENERGÍA ASEQUIBLE Y NO CONTAMINANTE</strong>
                </h2>

                <p class="mb-4 text-justify">
                  Entre los años 2000 y 2018, la cantidad de personas con acceso a energía eléctrica aumentó de 78 a 90 % y el número de personas sin energía bajó a 789 millones.
                </p>
                <p class="mb-4 text-justify">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-sm-12 ">
                ...
                <ul class="mb-4 text-justify">
                  <li>De aquí a 2030, garantizar el acceso universal a servicios energéticos asequibles, fiables y modernos.</li>
                  <li>De aquí a 2030, aumentar considerablemente la proporción de energía renovable en el conjunto de fuentes energéticas.</li>
                  <li>De aquí a 2030, duplicar la tasa mundial de mejora de la eficiencia energética.</li>
                  <li>De aquí a 2030, aumentar la cooperación internacional para facilitar el acceso a la investigación y la tecnología relativas a la energía limpia, incluidas las fuentes renovables, la eficiencia energética y las tecnologías avanzadas y menos contaminantes de combustibles fósiles, y promover la inversión en infraestructura energética y tecnologías limpias.</li>
                </ul>
              </div>
