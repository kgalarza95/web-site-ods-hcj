          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-12 col-lg-6 mr-auto order-2 ml-5">
                <img src="../images/objetivos/11.jpg" alt="Image" class="img-fluid">
              </div>

              <div class="col-md-12 col-lg-5 mb-5 mb-lg-0 order-1">
                <h2 class="mb-3 text-uppercase">Objetivo 11
                  <strong class="letra-negra font-weight-bold">CIUDADES Y COMUNIDADES SOSTENIBLES</strong>
                </h2>

                <p class="mb-4 text-justify">
                  Más de la mitad de la población mundial vive hoy en zonas urbanas. En 2050, esa cifra habrá aumentado
                  a 6.500 millones de personas, dos tercios de la humanidad. No es posible lograr un desarrollo
                  sostenible sin transformar radicalmente la forma en que construimos y administramos los espacios
                  urbanos.
                </p>
                <p class="mb-4 text-justify">
                  El rápido crecimiento de las urbes en el mundo en desarrollo, como resultado de la creciente población
                  y del incremento en la migración, ha provocado un incremento explosivo de las mega urbes,
                  especialmente en el mundo desarrollado, y los barrios marginales se están convirtiendo en una
                  característica más significativa de la vida urbana.
                </p>
                <p class="mb-4 text-justify">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-sm-12 ">
                ...
                <ul class="mb-4 text-justify">
                  <li>De aquí a 2030, asegurar el acceso de todas las personas a viviendas y servicios básicos
                    adecuados, seguros y asequibles y mejorar los barrios marginales.</li>
                  <li>De aquí a 2030, proporcionar acceso a sistemas de transporte seguros, asequibles, accesibles y
                    ...
                    vulnerabilidad, las mujeres, los niños, las personas con discapacidad y las personas de edad.</li>
                  <li>De aquí a 2030, aumentar la urbanización inclusiva y sostenible y la capacidad para la
                    planificación y la gestión participativas, integradas y sostenibles de los asentamientos humanos en
                    todos los países.</li>
                  <li>Redoblar los esfuerzos para proteger y salvaguardar el patrimonio cultural y natural del mundo.
                  </li>
                  <li>De aquí a 2030, reducir significativamente el número de muertes causadas por los desastres,
                    incluidos los relacionados con el agua, y de personas afectadas por ellos, y reducir
                    considerablemente las pérdidas económicas directas provocadas por los desastres en comparación con
                    el producto interno bruto mundial, haciendo especial hincapié en la protección de los pobres y las
                    personas en situaciones de vulnerabilidad.</li>
                  <li>De aquí a 2030, reducir el impacto ambiental negativo per capita de las ciudades, incluso
                    prestando especial atención a la calidad del aire y la gestión de los desechos municipales y de otro
                    tipo.</li>
                  <li>De aquí a 2030, proporcionar acceso universal a zonas verdes y espacios públicos seguros,
                  ...
                  <li>Apoyar los vínculos económicos, sociales y ambientales positivos entre las zonas urbanas,
                    periurbanas y rurales fortaleciendo la planificación del desarrollo nacional y regional.</li>
                  <li>De aquí a 2020, aumentar considerablemente el número de ciudades y asentamientos humanos que
