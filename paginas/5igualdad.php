          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-12 col-lg-6 mr-auto order-2 ml-5">
                <img src="../images/objetivos/5.jpg" alt="Image" class="img-fluid">
              </div>

              <div class="col-md-12 col-lg-5 mb-5 mb-lg-0 order-1">
                <h2 class="mb-3 text-uppercase">Objetivo 5
                  <strong class="letra-negra font-weight-bold">IGUALDAD DE GÉNERO</strong>
                </h2>

                <p class="mb-4 text-justify">
                  Terminar con las formas de discriminación contra las mujeres y niñas no es solo un derecho humano
                ...
                <p class="mb-4 text-justify">
                  ...
                  progreso notable en los últimos 20 años. Más niñas van a la escuela que hace 15 años, y la mayoría de
                  las regiones ha alcanzado la paridad de género en la educación primaria.
                </p>
                <p class="mb-4 text-justify">
                  Pero aunque hay más mujeres que nunca en el mercado laboral, todavía hay grandes desigualdades en
                  algunas regiones, y sistemáticamente a las mujeres se les niegan los mismos derechos laborales que
                  tienen los hombres. La violencia y la explotación sexual, la división desigual del trabajo no
                  remunerado -tanto doméstico como en el cuidado de otras personas- y la discriminación en la toma de
                  decisiones en el ámbito público son grandes obstáculos que aún persisten. El cambio climático y los
                  desastres continúan teniendo un efecto desproporcionado en las mujeres y los niños, al igual que el
                  conflicto y la migración.
                </p>
                <p class="mb-4 text-justify">
                  ...
                  para conseguir este objetivo. Hoy, más mujeres que nunca ocupan cargos públicos, pero alentar a más
                  mujeres para que se conviertan en líderes ayudará a alcanzar una mayor igualdad de género.
                </p>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-sm-12 ">
                ...
                <ul class="mb-4 text-justify">
                  <li>Poner fin a todas las formas de discriminación contra todas las mujeres y las niñas en todo el
                    mundo</li>
                  <li>Eliminar todas las formas de violencia contra todas las mujeres y las niñas en los ámbitos público
                    y privado, incluidas la trata y la explotación sexual y otros tipos de explotación</li>
                  <li>Eliminar todas las prácticas nocivas, como el matrimonio infantil, precoz y forzado y la
                    mutilación genital femenina

                  </li>
                  <li>Reconocer y valorar los cuidados y el trabajo doméstico no remunerados mediante servicios
                    públicos, infraestructuras y políticas de protección social, y promoviendo la responsabilidad
                    compartida en el hogar y la familia, según proceda en cada país.</li>
                </ul>
              </div>
